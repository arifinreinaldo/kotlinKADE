...
class MatchScheduleDetailFave : BaseActivity() {

    private lateinit var teamHome: Team
    private lateinit var teamAway: Team
    private var eventObject: LeagueEventModal? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eventObject = intent.getSerializableExtra("eventObject") as LeagueEventModal
        ...
        if (checkFavorite(idEvent)) {
            ...
            database.use {
                rst = insert(LeagueEventModal.TableName,
                        ...
                        LeagueEventModal.intHomeScore to eventObject?.idHomeScore,
                        LeagueEventModal.intAwayScore to eventObject?.idAwayScore,
